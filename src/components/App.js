...
class App extends Component {
	...
	onFormSubmit = e => {
		...
		if (this.state.canSubmit === false) {
			...
			axios
				.post('https://cxynbjn3wf.execute-api.eu-west-2.amazonaws.com/production/flatbond', {
	...
	render() {
		return (
			<React.Fragment>
				<GlobalStyle />
				<div className="hide" ref={this.errorLoadFormRef}>
					<h1>{this.state.formLoadingFail}</h1>
				</div>
				<div ref={this.flatbondFormRef} className="bond-form hide">
					...
					<form onSubmit={this.onFormSubmit}>
						...
						<p className="hide warning" ref={this.errorWeeklyRef}>
							{this.state.weeklyRentError}
						</p>
						<p className="hide warning" ref={this.errorMonthlyRef}>
							{this.state.monthlyRentError}
						</p>
						<div className="form-label">
							<label>Membership Fee</label>
						</div>
						<div className="form-member-fee">
						...
						<div>
							<p className="hide warning" ref={this.errorFormSubmitRef}>
